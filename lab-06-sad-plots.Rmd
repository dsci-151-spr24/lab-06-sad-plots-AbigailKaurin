...
***Making the trend line for part-time faculty more visible would help this objective***    
...
***What I would do to improve this visualization is to remove the pie chart and change the axies for "x" and "y" so that the numerical data would run along the x axis, and on the y axis each country would have its own "fill" and be represented as a line.***
